        ...
        <section class="team-section">
            <div class="container">
                <div class="row justify-content-center">
                    @foreach($others as $key => $pengurus)
                        <div class="col-6 col-sm-4 col-md-2 col-lg-2">
                            <div class="team-member" data-aos="fade-up" data-aos-delay="{{ 100 * $key }}">
                                @if($pengurus->gambar)
                                    <img src="{{ asset('storage/' . $pengurus->gambar) }}" 
                                        alt="{{ $pengurus->nama }}" 
                                        class="team-avatar">
                                @endif
                                <div class="team-name">{{ $pengurus->nama }}</div>
                                <div class="team-position">{{ $pengurus->jabatan }}</div>
                            </div>
                        </div>
                    @endforeach
                </div>
