        ...
        <div class="text-center text-white py-4" data-aos="fade-down">
            ...
            <div class="d-flex justify-content-center">
                <div class="bg-black bg-opacity-20 rounded-pill px-4 py-2">
                    ...
                    <span class="fw-semibold">{{ $news->total() }} Artikel Tersedia</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container py-5">
        ...
        <div class="row g-4">
            @foreach($news as $index => $item)
                {{-- AOS: Fade Up dengan delay bertahap berdasarkan index ($index % 3 untuk grid 3 kolom) --}}
                <div class="col-lg-4 col-md-6" 
                     data-aos="fade-up" 
                     data-aos-delay="{{ ($index % 3) * 150 }}">
                    <article class="news-card">
                        <a href="{{ route('noauth.news.show', $item->id) }}" class="text-decoration-none">
                                    ...
                                    <div class="mt-auto">
                                        <div class="d-flex align-items-center justify-content-between pt-3 border-top border-light mb-3">
                                            ...
                                            <div class="d-flex align-items-center text-muted small">
                                                ...
                                                <span style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis; max-width: 100px;">{{ $item->penulis }}</span>
                                            </div>
                                        </div>
        ...
        <div class="row mt-5 pt-4 border-top border-light" data-aos="fade-up">
            <div class="col-md-6 mb-4 mb-md-0">
                <a href="{{ route('noauth.news.index') }}" 
