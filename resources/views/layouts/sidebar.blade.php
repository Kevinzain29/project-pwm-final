...
<div class="sidebar">
    ...
    <div class="sidebar-menu">
        <a class="{{ request()->routeIs('admin.dashboard') ? 'active' : '' }}" href="{{ route('admin.dashboard') }}"><i class="fas fa-tachometer-alt me-1"></i> Dashboard</a>
        <a class="{{ request()->routeIs('admin.kategori.index') ? 'active' : '' }}" href="{{ route('admin.kategori.index') }}"><i class="fas fa-tags me-1"></i> Kategori</a>
        <a class="{{ request()->routeIs('admin.users.index') ? 'active' : '' }}" href="{{ route('admin.users.index') }}"><i class="fas fa-users me-1"></i> Users</a>
        <a class="{{ request()->routeIs('profile.edit') ? 'active' : '' }}" href="{{ route('profile.edit') }}"><i class="fas fa-user me-1"></i> Profile</a>
        <a class="{{ request()->routeIs('admin.regulasi.index') ? 'active' : '' }}" href="{{ route('admin.regulasi.index') }}"><i class="fas fa-user-shield me-1"></i> Regulasi</a>
        <a class="{{ request()->routeIs('admin.daerah.index') ? 'active' : '' }}" href="{{ route('admin.daerah.index') }}"><i class="fas fa-map-marker-alt me-1"></i> Daerah</a>
