...
{{-- Tambahan CSS khusus halaman welcome --}}
@section('styles')
<style>
    /* Hero Section Styles */
    .carousel-slide {
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12 col-sm-6" data-aos="fade-left" data-aos-delay="100">
                        <div class="rounded-4 p-4 border service-card h-100" 
                            ...
                            <div class="rounded-4 d-flex align-items-center justify-content-center mb-3 icon-service" 
                                ...
                                <img src="{{ asset('images/mentoring.png') }}" alt="Mentoring Icon" class="img-fluid" style="width: 32px; height: 32px; object-fit: contain;">
                            </div>
                    ...
                    <div class="col-12 col-sm-6" data-aos="fade-left" data-aos-delay="200">
                        <div class="rounded-4 p-4 border service-card h-100" 
                            ...
                            <div class="rounded-4 d-flex align-items-center justify-content-center mb-3 icon-service" 
                                 style="width: 64px; height: 64px; background: linear-gradient(135deg, #60A5FA, #2563EB); transition: transform 0.3s;">
                                <img src="{{ asset('images/blockchain.png') }}" alt="Blockchain Icon" class="img-fluid" style="width: 32px; height: 32px; object-fit: contain;">
                            </div>
                    ...
                    <div class="col-12 col-sm-6" data-aos="fade-left" data-aos-delay="100">
                        <div class="rounded-4 p-4 border service-card h-100" 
                            ...
                            <div class="rounded-4 d-flex align-items-center justify-content-center mb-3 icon-service" 
                                 style="width: 64px; height: 64px; background: linear-gradient(135deg, #60A5FA, #2563EB); transition: transform 0.3s;">
                                <img src="{{ asset('images/user.png') }}" alt="User Icon" class="img-fluid" style="width: 32px; height: 32px; object-fit: contain;">
                            </div>
                    ...
                    <div class="col-12 col-sm-6" data-aos="fade-left" data-aos-delay="200"> 
                        <div class="rounded-4 p-4 border service-card h-100" 
                            ...
                            <div class="rounded-4 d-flex align-items-center justify-content-center mb-3 icon-service" 
                                 style="width: 64px; height: 64px; background: linear-gradient(135deg, #60A5FA, #2563EB); transition: transform 0.3s;">
                                <img src="{{ asset('images/informative.png') }}" alt="Info Icon" class="img-fluid" style="width: 32px; height: 32px; object-fit: contain;">
                            </div>
            ...
            <div class="slider-track-custom d-flex">
                ...
                <div class="logo-set-custom d-flex">
                    ...
                    <div class="logo-item-custom d-flex flex-column align-items-center">
                        <div class="p-4">
                            <div class="rounded-circle bg-white shadow d-flex align-items-center justify-content-center overflow-hidden" style="width: 96px; height: 96px;">
                                <img src="{{ asset('images/Logo_PWM_DIY.png') }}" 
                                    alt="Logo PWM" 
                    ...
                    <div class="logo-item-custom d-flex flex-column align-items-center">
                        <div class="p-4">
                            <div class="rounded-circle bg-white shadow d-flex align-items-center justify-content-center overflow-hidden" style="width: 96px; height: 96px;">
                                <img src="{{ asset('images/Lp umkm.png') }}" 
                                    alt="Logo AUM" 
                                    class="img-fluid" style="width: 64px; height: 64px; object-fit: contain;">
                            </div>
                        </div>
                    ...
                    <div class="logo-item-custom d-flex flex-column align-items-center">
                        <div class="p-4">
                            <div class="rounded-circle bg-white shadow d-flex align-items-center justify-content-center overflow-hidden" style="width: 96px; height: 96px;">
                                <img src="{{ asset('images/kementrian.png') }}" 
                                    alt="Logo Kemenag" 
                                    class="img-fluid" style="width: 64px; height: 64px; object-fit: contain;">
                            </div>
                        </div>
                    ...
                    <div class="logo-item-custom d-flex flex-column align-items-center">
                        <div class="p-4">
                            <div class="rounded-circle bg-white shadow d-flex align-items-center justify-content-center overflow-hidden" style="width: 96px; height: 96px;">
                                <img src="{{ asset('images/bank1.png') }}" 
                    ...
                    <div class="logo-item-custom d-flex flex-column align-items-center">
                        <div class="p-4">
                            <div class="rounded-circle bg-white shadow d-flex align-items-center justify-content-center overflow-hidden" style="width: 96px; height: 96px;">
                                <img src="{{ asset('images/dinaskop.png') }}" 
                                    alt="Logo Dinkop" 
                                    class="img-fluid" style="width: 64px; height: 64px; object-fit: contain;">
                            </div>
                        </div>
