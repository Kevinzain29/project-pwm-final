        ...
        <div class="detail-container">
            <div class="content-card">
                ...
                <div class="info-section">
                    ...
                    <div class="info-value">{{ $divisi->nama }}</div>
                ...
                <div class="list-section">
                    ...
                    @if($divisi->penguruses->count())
                        <div class="member-list">
                            @foreach($divisi->penguruses as $pengurus)
                                <div class="member-item">
                                    <div class="member-icon">
                                        {{ strtoupper(substr($pengurus->nama, 0, 1)) }}
                                    </div>
                                    <div>
                                        <div style="font-weight: 700; color: #1e293b;">{{ $pengurus->nama }}</div>
                                        <div style="font-size: 0.85rem; color: #64748b;">{{ $pengurus->jabatan }}</div>
                                    </div>
                                </div>
                            @endforeach
                        </div>
            ...
            <div class="text-center">
                <a href="{{ route('admin.divisi.index') }}" class="btn-back">
