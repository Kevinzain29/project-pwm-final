                ...
                <form action="{{ route('admin.news.update', $news->id) }}" method="POST" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="form-group">
                        ...
                        <textarea 
                            ...
                            minlength="100" 
                            maxlength="3000"
                            placeholder="Tulis konten berita Anda di sini... (minimal 100 karakter)">{{ old('deskripsi', $news->deskripsi) }}</textarea>
                    ...
                    <div class="form-actions">
                        ...
                        <a href="{{ route('admin.news.index') }}" class="btn-cancel">Kembali</a>
                    </div>
                </form>
            </div>
        </div>
