    ...
    <div class="container">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <h2 class="stat-value">{{ $news->total() }}</h2>
        ...
        <div class="action-section">
            <a href="{{ route('admin.news.create') }}" class="btn-add-primary">
                Tambah Berita Baru
            </a>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="news-info">
                                    <h4>{{ $item->judul }}</h4>
                                    <div class="news-author">{{ $item->penulis }}</div>
                                </div>
                            </td>
                            <td>
                                @if($item->gambar)
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="{{ route('admin.news.edit', $item->id) }}" class="btn-action-edit">
                                        Edit
                                    </a>
