                        ...
                        <tbody>
                            @forelse($kategoris as $key => $kategori)
                                <tr>
                                    ...
                                    <td><span class="badge-count">{{ $kategori->umkms_count }}</span></td>
                                    <td>
                                        <div class="action-buttons">
                                            <a href="{{ route('admin.kategori.edit', $kategori) }}" class="btn-edit">Edit</a>
                                            <form action="{{ route('admin.kategori.destroy', $kategori) }}" method="POST" class="delete-form">
                                                @csrf 
                                                @method('DELETE')
