    ...
    <div class="container">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <h2 class="stat-value">{{ $penguruses->total() }}</h2>
        ...
        <div class="action-section">
            <a href="{{ route('admin.penguruses.create') }}" class="btn-add-primary">
            ...
            <div class="table-wrapper">
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <span class="pengurus-id">{{ $pengurus->id }}</span>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="pengurus-deskripsi">{{ $pengurus->deskripsi }}</div>
                            </td>
                            <td>
                                @if($pengurus->gambar)
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="{{ route('admin.penguruses.edit', $pengurus->id) }}" class="btn-action-edit">
                                        Edit
                                    </a>
                                    <form action="{{ route('admin.penguruses.destroy', $pengurus->id) }}" method="POST" style="display: inline;">
                                        @csrf
                                        @method('DELETE')
