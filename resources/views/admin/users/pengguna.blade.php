                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($user->approver)
                                            <div class="approver-info">
                                                <strong>{{ $user->approver->name }}</strong>
                                                <span class="approver-date">{{ $user->approved_at->format('M d, Y') }}</span>
                                            </div>
                                        @else
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            ...
                                            @if($user->is_active)
                                                <form action="{{ route('admin.users.deactivate', $user) }}" method="POST" style="margin: 0;">
                                                    @csrf
                                            ...
                                            @else
                                                <form action="{{ route('admin.users.activate', $user) }}" method="POST" style="margin: 0;">
                                                    @csrf
                                            ...
                                            <!-- Delete -->
                                            <form action="{{ route('admin.users.delete', $user) }}" method="POST" style="margin: 0;" onsubmit="return confirm('Are you sure you want to delete this user?');">
                                                @csrf
                                                @method('DELETE')
