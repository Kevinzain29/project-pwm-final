    ...
    <div class="container">
        ...
        <div class="content-card">
            <div class="card-header-custom">
                ...
                @if($users->count() > 0)
                    <span class="pending-count-badge">{{ $users->count() }}</span>
                @endif
            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="action-buttons">
                                            <form method="POST" action="{{ route('admin.approve-user', $user) }}" style="margin: 0;">
                                                @csrf
                                            ...
                                            <form method="POST" action="{{ route('admin.reject-user', $user) }}" style="margin: 0;">
                                                @csrf
                                                @method('DELETE')
