        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="admin-stat-card card-success">
                    <div class="admin-stat-card-body">
                        <div class="admin-stat-icon-wrapper mb-2">
                        <img src="{{ asset('images/People.png') }}" alt="Karyawan" title="Karyawan" class="admin-stat-icon" width="40" height="40">
                    </div>
                        <div class="admin-stat-title">Total Karyawan</div>
                        <h2 class="admin-stat-value">{{ number_format($totalKaryawan) }}</h2>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="admin-stat-card card-info">
                    <div class="admin-stat-card-body">
                        <div class="admin-stat-icon-wrapper mb-2">
                        <img src="{{ asset('images/news.png') }}" alt="Berita" title="Berita" class="admin-stat-icon" width="40" height="40">
                    </div>
                        <div class="admin-stat-title">Total Berita</div>
                        <h2 class="admin-stat-value">{{ number_format($totalNews) }}</h2>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="admin-stat-card card-warning">
                    <div class="admin-stat-card-body">
                        <div class="admin-stat-icon-wrapper mb-2">
                        <img src="{{ asset('images/user.png') }}" alt="Pengurus" title="Pengurus" class="admin-stat-icon" width="40" height="40">
                    </div>
                        <div class="admin-stat-title">Total Pengurus</div>
                        <h2 class="admin-stat-value">{{ number_format($totalPengurus) }}</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="admin-data-section" style="animation-delay: 0.1s">
            ...
            <div class="admin-table-container">
                <table class="admin-modern-table">
                    ...
                    <tbody>
                        @foreach($totalPerDaerah as $nama => $jumlah)
                            <tr>
                                <td>{{ $nama }}</td>
                                <td>
                                    <span class="admin-count-badge">{{ number_format($jumlah) }}</span>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
        ...
        <div class="admin-data-section" style="animation-delay: 0.2s">
            ...
            <div class="admin-table-container">
                <table class="admin-modern-table">
                    ...
                    <tbody>
                        @foreach($totalPerSektor as $nama => $jumlah)
                            <tr>
                                <td>{{ $nama }}</td>
                                <td>
                                    <span class="admin-count-badge">{{ number_format($jumlah) }}</span>
        ...
        <div class="admin-data-section" style="animation-delay: 0.3s">
            ...
            <div class="admin-table-container">
                <table class="admin-modern-table">
                    ...
                    <tbody>
                        @foreach($totalPerKategori as $nama => $jumlah)
                            <tr>
                                <td>{{ $nama }}</td>
                                <td>
                                    <span class="admin-count-badge">{{ number_format($jumlah) }}</span>
