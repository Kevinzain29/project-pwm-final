        ...
        <div class="form-container">
            <div class="form-card">
                ...
                <div class="card-body-custom">
                    <form action="<?php echo e(route('admin.kategori.update', $kategori)); ?>" method="POST" novalidate>
                        <?php echo csrf_field(); ?> 
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                ><?php echo e(old('deskripsi', $kategori->deskripsi)); ?></textarea>
                            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\project-pwm-final\resources\views\admin\kategori\edit.blade.php ENDPATH**/ ?>