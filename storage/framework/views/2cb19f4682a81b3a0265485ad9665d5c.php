    ...
    <div class="container">
        ...
        <div class="stats-banner">
            <div class="stat-item">
                ...
                <div class="stat-info">
                    <h3><?php echo e($lowongans->total()); ?></h3>
        ...
        <div class="action-bar">
            ...
            <!-- Back Button -->
            <a href="<?php echo e(route('admin.lowongan.index')); ?>" class="btn-back">
                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="company-name"><?php echo e($l->perusahaan); ?></div>
                                </td>
                                <td>
                                    <div class="location-text"><?php echo e($l->lokasi); ?></div>
                                </td>
                                <td>
                                    <div class="phone-text"><?php echo e($l->no_hp); ?></div>
                                </td>
                                <td>
                                    <span class="date-badge start">
                                        <?php echo e($l->tanggal_mulai?->format('d M Y, H:i')); ?>

                                    </span>
                                </td>
                                <td>
                                    <span class="date-badge end">
                                        <?php echo e($l->tanggal_akhir?->format('d M Y, H:i')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\project-pwm-final\resources\views\admin\lowongan\history.blade.php ENDPATH**/ ?>