    ...
    <div class="container">
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                <form action="<?php echo e(route('admin.lowongan.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                            ...
                            minlength="100"
                            maxlength="5000"
                            placeholder="Tulis deskripsi lengkap tentang pekerjaan... (minimal 100 karakter)"><?php echo e(old('deskripsi')); ?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-icon icon-company">
                                <input 
                                    ...
                                    id="perusahaan"
                                    name="perusahaan" 
                                    class="form-control-modern <?php $__errorArgs = ['perusahaan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-icon icon-location">
                                <input 
                                    ...
                                    id="lokasi"
                                    name="lokasi" 
                                    class="form-control-modern <?php $__errorArgs = ['lokasi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-icon icon-phone">
                            <input 
                                ...
                                id="no_hp"
                                name="no_hp" 
                                class="form-control-modern <?php $__errorArgs = ['no_hp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input 
                                ...
                                id="tanggal_mulai"
                                name="tanggal_mulai" 
                                class="form-control-modern <?php $__errorArgs = ['tanggal_mulai'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input 
                                ...
                                id="tanggal_akhir"
                                name="tanggal_akhir" 
                                class="form-control-modern <?php $__errorArgs = ['tanggal_akhir'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-actions">
                        ...
                        <a href="<?php echo e(route('admin.lowongan.index')); ?>" class="btn-cancel">Batal</a>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\project-pwm-final\resources\views\admin\lowongan\create.blade.php ENDPATH**/ ?>