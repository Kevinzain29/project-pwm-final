...
<section class="container-fluid p-3" style="background: linear-gradient(135deg, #1e4db7 0%, #2563eb 100%); position: relative; overflow: hidden; padding: 70px 0;">
    ...
    <div class="container" style="position: relative; z-index: 2;">
        ...
        <div class="d-flex justify-content-between align-items-center mb-5" data-aos="fade-down">
            ...
            <?php if($totalNews > 6): ?>
            <a href="<?php echo e(route('noauth.news.all')); ?>" 
        ...
        <div class="row">
            ...
            <div class="col-lg-7 mb-4" data-aos="fade-right" data-aos-delay="200">
                <?php if($news->isNotEmpty()): ?>
                    <?php $mainNews = $news->first(); ?>
                    <article class="position-relative">
                        <a href="<?php echo e(route('noauth.news.show', $mainNews->id)); ?>" 
                           ...
                           onmouseout="this.style.transform='translateY(0) rotateX(0deg)'; this.style.boxShadow='0 15px 35px rgba(0,0,0,0.15), 0 5px 15px rgba(0,0,0,0.1)';">
                            ...
                            <div class="p-4" style="background: linear-gradient(145deg, #ffffff, #f8faff);">
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div>
                                        <small class="text-primary fw-bold d-block" style="font-size: 13px;">
                                            <?php echo e($mainNews->penulis); ?>

                                        </small>
                                        <small class="text-muted" style="font-size: 12px;">
                                            <i class="fas fa-calendar-alt me-1"></i>
                                            <?php echo e($mainNews->created_at->format('d M Y')); ?>
                                ...
                                <p class="text-muted mb-3" style="line-height: 1.7; font-size: 0.95rem;">
                                    <?php echo e(Str::limit(strip_tags($mainNews->deskripsi), 120, '...')); ?>
            ...
            <div class="col-lg-5">
                <div class="d-flex flex-column gap-4">
                    <?php $__currentLoopData = $news->skip(1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <article class="news-item-<?php echo e($index); ?>" data-aos="fade-left" data-aos-delay="<?php echo e(300 + ($index * 100)); ?>">
                            <a href="<?php echo e(route('noauth.news.show', $item->id)); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\project-pwm-final\resources\views/noauth/news/index.blade.php ENDPATH**/ ?>