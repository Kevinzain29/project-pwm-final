    ...
    <div class="container">
        ...
        <div class="stats-grid">
            <div class="stat-card pending">
                ...
                <h2 class="stat-value"><?php echo e($pendingUsers); ?></h2>
            ...
            <div class="stat-card total">
                ...
                <h2 class="stat-value"><?php echo e($totalUsers); ?></h2>
        ...
        <div class="action-section">
            <div class="action-grid">
                <a href="<?php echo e(route('admin.users.create')); ?>" class="btn-action-card btn-add-user">
                ...
                <a href="<?php echo e(route('admin.users.pending')); ?>" class="btn-action-card btn-pending">
                    <div class="btn-icon">🕒</div>
                    <div class="btn-text">
                ...
                <a href="<?php echo e(route('admin.users.all')); ?>" class="btn-action-card btn-all-users">
                    <div class="btn-icon">📋</div>
                    <div class="btn-text">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\project-pwm-final\resources\views\admin\users\index.blade.php ENDPATH**/ ?>