...
<div class="form-wrapper">
    <div class="container">
        ...
        <div class="page-header">
            <h1>Edit Berita</h1>
            <div class="page-subtitle">Perbarui informasi berita yang sudah ada</div>
        </div>
...
unset($__errorArgs, $__bag); ?>" 
                            minlength="100" 
                            maxlength="3000"
                            placeholder="Tulis konten berita Anda di sini... (minimal 100 karakter)"><?php echo e(old('deskripsi', $news->deskripsi)); ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <?php if($news->gambar): ?>
                            <div class="current-image-wrapper">
                                ...
                                <div>
                                    <img src="<?php echo e(asset('storage/' . $news->gambar)); ?>" class="current-image" alt="Gambar Berita">
                                </div>
                            </div>
                        <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn-update">Update Berita</button>
