...
<div class="form-wrapper">
    <div class="container">
        ...
        <div class="page-header">
            <h1>Tambah Daerah</h1>
            <div class="page-subtitle">Tambahkan data daerah baru untuk UMKM</div>
        </div>
        ...
        <div class="form-container">
            <div class="form-card">
                ...
                <div class="card-body-custom">
                    <form action="<?php echo e(route('admin.daerah.store')); ?>" method="POST" novalidate>
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn-save">Simpan Daerah</button>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\project-pwm-final\resources\views\admin\daerah\create.blade.php ENDPATH**/ ?>