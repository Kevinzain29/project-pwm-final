...
unset($__errorArgs, $__bag); ?>" 
                            ...
                            minlength="3"
                            maxlength="500"
                            placeholder="Tulis deskripsi singkat tentang pengurus... (minimal 3 karakter)"><?php echo e(old('deskripsi', $pengurus->deskripsi)); ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <?php if($pengurus->gambar): ?>
                            <div class="current-image-wrapper">
                                ...
                                <div>
                                    <img src="<?php echo e(asset('storage/'.$pengurus->gambar)); ?>" class="current-image" alt="<?php echo e($pengurus->nama); ?>">
                                </div>
                            </div>
                        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\project-pwm-final\resources\views\admin\penguruses\edit.blade.php ENDPATH**/ ?>