        ...
        <div class="form-container">
            ...
            <div class="form-card">
                ...
                <div class="card-body-custom">
                    <form action="<?php echo e(route('admin.divisi.update', $divisi)); ?>" method="POST" novalidate>
                        <?php echo csrf_field(); ?> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-icon icon-division">
                                <input 
                                    ...
                                    id="nama"
                                    name="nama"
                                    value="<?php echo e(old('nama', $divisi->nama)); ?>"
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                ><?php echo e(old('deskripsi', $divisi->deskripsi)); ?></textarea>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-actions">
                            ...
                            <a href="<?php echo e(route('admin.divisi.index')); ?>" class="btn-cancel">Batal</a>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\project-pwm-final\resources\views\admin\divisi\edit.blade.php ENDPATH**/ ?>