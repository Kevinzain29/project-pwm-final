            ...
            <div class="col-lg-10">
                ...
                <nav class="mb-4">
                    <div class="d-flex align-items-center">
                        <a href="<?php echo e(route('noauth.lowongan.index')); ?>" class="text-white text-decoration-none me-3" style="opacity: 0.8; transition: opacity 0.3s;">
...
<header class="mb-4">
    <div class="row align-items-center mb-4">
            ...
            <div class="d-flex align-items-center mb-3">
                ...
                <div>
                    <h6 class="mb-1 text-success fw-bold" style="font-size: 14px;">
                        <?php echo e($lowongan->perusahaan); ?>

                    </h6>
                    <!-- Tambahan tanggal -->
                    <small class="text-muted d-block">
                        <i class="far fa-calendar-alt me-1"></i>
                        Dibuka: <?php echo e(\Carbon\Carbon::parse($lowongan->tanggal_mulai)->translatedFormat('d F Y')); ?>

                    </small>
                    <small class="text-muted d-block">
                        <i class="far fa-calendar-times me-1"></i>
                        Ditutup: <?php echo e(\Carbon\Carbon::parse($lowongan->tanggal_akhir)->translatedFormat('d F Y H:i')); ?>
        ...
        <div class="col-md-4 text-md-end">
            <!-- Status -->
            <?php if(\Carbon\Carbon::now()->greaterThan($lowongan->tanggal_akhir)): ?>
        ...
        <?php echo e($lowongan->judul); ?>
                        ...
                        <div class="article-content" style="position: relative;">
                            ...
                            <div class="content-text" style="font-size: 1rem; line-height: 1.8; color: #4a5568; text-align: justify;">
                                <?php echo nl2br(e($lowongan->deskripsi)); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\project-pwm-final\resources\views/noauth/lowongan/show.blade.php ENDPATH**/ ?>