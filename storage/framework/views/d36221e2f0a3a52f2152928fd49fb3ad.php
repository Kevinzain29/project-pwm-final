...
<div class="form-wrapper">
    <div class="container">
        ...
        <div class="page-header">
            <h1>Edit Sektor</h1>
            <div class="page-subtitle">Perbarui informasi data sektor</div>
        </div>
        ...
        <div class="form-container">
            <div class="form-card">
                ...
                <div class="card-body-custom">
                    <form action="<?php echo e(route('admin.sektor.update', $sektor)); ?>" method="POST" novalidate>
                        <?php echo csrf_field(); ?> 
                        <?php echo method_field('PUT'); ?>
                        
                        
                        <div class="form-group">
                            <label for="nama" class="form-label">Nama Sektor</label>
                            <div class="input-icon icon-sector">
                                <input 
                                    type="text" 
                                    id="nama"
                                    name="nama"
                                    value="<?php echo e(old('nama', $sektor->nama)); ?>"
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    minlength="3"
                                    maxlength="100"
                                    placeholder="Masukkan deskripsi sektor..."
                                ><?php echo e(old('deskripsi', $sektor->deskripsi)); ?></textarea>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn-update">Update Sektor</button>
                            <a href="<?php echo e(route('admin.sektor.index')); ?>" class="btn-cancel">Batal</a>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\project-pwm-final\resources\views\admin\sektor\edit.blade.php ENDPATH**/ ?>