    ...
    <div class="container">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <h2 class="stat-value"><?php echo e($totalUmkm); ?></h2>
            </div>
            <div class="stat-card">
                <div class="stat-icon-wrapper karyawan"></div>
                <div class="stat-label">Total Karyawan</div>
                <h2 class="stat-value"><?php echo e($totalKaryawan); ?></h2>
            </div>
        </div>
        ...
        <div class="chart-section">
            <div class="chart-grid">
                <div class="chart-card">
                    <h5 class="chart-title">📈 Grafik Pertumbuhan Bulanan (<?php echo e($tahunSekarang); ?>)</h5>
        ...
        <div class="filter-section">
            ...
            <div>
                ...
                <div class="filter-buttons">
                    <a href="<?php echo e(route('admin.umkm.index')); ?>" 
                       class="filter-btn <?php echo e(request('kategori_id') ? '' : 'active-primary'); ?>">
                        Semua
                    </a>
                    <?php $__currentLoopData = $kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('admin.umkm.index', array_merge(request()->query(), ['kategori_id' => $kategori->id]))); ?>"
                           class="filter-btn <?php echo e(request('kategori_id') == $kategori->id ? 'active-primary' : ''); ?>">
            ...
            <div>
                ...
                <div class="filter-buttons">
                    <a href="<?php echo e(route('admin.umkm.index', ['kategori_id' => request('kategori_id')])); ?>" 
                       class="filter-btn <?php echo e(request('daerah_id') ? '' : 'active-success'); ?>">
                        Semua
                    </a>
                    <?php $__currentLoopData = $daerahs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $daerah): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('admin.umkm.index', array_merge(request()->query(), ['daerah_id' => $daerah->id]))); ?>"
                           class="filter-btn <?php echo e(request('daerah_id') == $daerah->id ? 'active-success' : ''); ?>">
            ...
            <div>
                ...
                <div class="filter-buttons">
                    ...
                    class="filter-btn <?php echo e(request('sektor_id') ? '' : 'active-warning'); ?>">
                        Semua
                    </a>
                    <?php $__currentLoopData = $sektors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sektor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        class="filter-btn <?php echo e(request('sektor_id') == $sektor->id ? 'active-warning' : ''); ?>">
        ...
        <div class="search-section">
            <form method="GET" action="<?php echo e(route('admin.umkm.index')); ?>" id="searchForm">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\project-pwm-final\resources\views/admin/umkm/index.blade.php ENDPATH**/ ?>