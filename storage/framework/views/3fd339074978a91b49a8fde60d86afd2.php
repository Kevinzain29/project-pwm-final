...
<footer class="footer">
    ...
    <div class="copyright">
        <div class="container">
            <p class="mb-0">&copy; <?php echo e(date('Y')); ?> PWM DIY. All rights reserved. | Lembaga Pengembang UMKM</p>
        </div>
    </div>
</footer><?php /**PATH C:\laragon\www\project-pwm-final\resources\views\layouts\footer.blade.php ENDPATH**/ ?>