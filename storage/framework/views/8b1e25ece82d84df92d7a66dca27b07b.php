...
<div class="edit-wrapper">
    <div class="container">
        ...
        <div class="form-container">
            <form action="<?php echo e(route('admin.lowongan.update', $lowongan->id)); ?>" method="POST" enctype="multipart/form-data" id="editForm">
                <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?> 
                                <div class="invalid-feedback">
                                    <span class="error-icon">⚠️</span> <?php echo e($message); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                  ...
                                  minlength="100"
                                  maxlength="5000"
                                  placeholder="Jelaskan detail lowongan pekerjaan, kualifikasi, dan benefit yang ditawarkan..."><?php echo e(old('deskripsi', $lowongan->deskripsi)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-actions">
                    ...
                    <a href="<?php echo e(route('admin.lowongan.index')); ?>" class="btn-cancel">
                        Batal
                    </a>
                </div>
            </form>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\project-pwm-final\resources\views\admin\lowongan\edit.blade.php ENDPATH**/ ?>