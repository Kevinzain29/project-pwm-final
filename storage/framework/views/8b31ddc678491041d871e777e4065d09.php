...
<div class="form-wrapper">
    <div class="container">
        ...
        <div class="page-header">
            <h1>Edit Daerah</h1>
            <div class="page-subtitle">Perbarui informasi data daerah</div>
        </div>
        ...
        <div class="form-container">
            <div class="form-card">
                ...
                <div class="card-body-custom">
                    <form action="<?php echo e(route('admin.daerah.update', $daerah)); ?>" method="POST" novalidate>
                        <?php echo csrf_field(); ?> 
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    minlength="3"
                                    maxlength="100"
                                    placeholder="Masukkan deskripsi daerah..."
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn-update">Update Daerah</button>
                            <a href="<?php echo e(route('admin.daerah.index')); ?>" class="btn-cancel">Batal</a>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\project-pwm-final\resources\views\admin\daerah\edit.blade.php ENDPATH**/ ?>