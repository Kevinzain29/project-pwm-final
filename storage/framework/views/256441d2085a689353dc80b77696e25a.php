                ...
                <div class="card-body-custom">
                    <form action="<?php echo e(route('admin.users.store')); ?>" method="POST" novalidate>
                        ...
                        <div class="form-actions">
                            ...
                            <a href="<?php echo e(route('admin.users.index')); ?>" class="btn-cancel">
                                <span>Cancel</span>
                            </a>
                        </div>
                    </form>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\project-pwm-final\resources\views\admin\users\create.blade.php ENDPATH**/ ?>